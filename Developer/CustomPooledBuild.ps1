 ...
 $FSLogixInstallerFile="fslogix_download.zip"
 ...
 $FSLogixoutputPath = $FSLogixPath + '\' + $WVDFslogixInstaller
 Invoke-WebRequest -Uri $WVDflogixURL -OutFile $FSLogixoutputPath
 Invoke-WebRequest $fsLogixURL -OutFile $FSLogixPath\$FSLogixInstallerFile
 ...
 #Install FSLogix
 write-host 'AIB Customization: Starting Install FSLogix'
 Expand-Archive $FSLogixPath\$FSLogixInstallerFile -DestinationPath $FSLogixPath
